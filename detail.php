...
// Periksa apakah ID artikel dikirim melalui URL
if(isset($_GET['id'])) {
    $id_artikel = $_GET['id'];
    
    // Persiapkan query untuk mengambil data artikel berdasarkan ID
    $statement = $db->prepare("SELECT * FROM `artikel` WHERE id_artikel = :id");
    $statement->execute(array(':id' => $id_artikel));
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav nav-link">
                        ...
                        <li class="navbar-right"><a href="login"><i class="fa fa-fw fa-sign-in"></i> Login Admin</a></li>
    ...
    <div class="main-content">
        ...
        <div class="section">
            <div class="row">
                ...
                <div class="col-md-8">
                    <br>
                    <h3 class="text-center h3-custom"><?php echo $artikel['judul']; ?></h3>
                    ...
                    <div class="scroll-laporan">
                        ...
                        <img src="admin/images/artikel/<?php echo $artikel['gambar']; ?>" alt="<?php echo $artikel['judul']; ?>" class="gambar-artikel" style="max-width: 100%; height: auto;">
                        <!-- Tampilkan isi artikel -->
                        <p><?php echo nl2br($artikel['isi']); ?></p>
                        <p style="text-align: right;">Tanggal Posting: <?php echo date('d F Y H:i', strtotime($artikel['tglartikel'])); ?></p>
